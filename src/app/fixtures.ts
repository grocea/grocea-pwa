...
export const initialState: GroceaState = {
  ...
  recipes: [
    { id: 'tomato-egg-rice', name: 'Tomato egg rice', description: 'A fast, comforting rice bowl with soft eggs and juicy tomatoes.', baseServings: 2, scope: 'global', ingredients: [{ ingredientId: 'rice', quantity: 300_000n }, { ingredientId: 'eggs', quantity: 2_000n }, { ingredientId: 'tomatoes', quantity: 3_000n }], steps: ['Cook the rice until tender.', 'Scramble the eggs and set aside.', 'Cook tomatoes, return eggs, and serve over rice.'] },
    { id: 'oat-porridge', name: 'Oat porridge', description: 'Creamy everyday oats.', baseServings: 1, scope: 'global', ingredients: [{ ingredientId: 'oats', quantity: 80_000n }, { ingredientId: 'milk', quantity: 250_000n }], steps: ['Simmer oats and milk for 6 minutes.', 'Rest briefly, then serve.'] },
    { id: 'fried-rice', name: 'Vegetable fried rice', description: 'A quick pantry dinner.', baseServings: 2, scope: 'global', ingredients: [{ ingredientId: 'rice', quantity: 300_000n }, { ingredientId: 'eggs', quantity: 2_000n }, { ingredientId: 'carrots', quantity: 2_000n }], steps: ['Stir-fry vegetables.', 'Add rice and eggs, then season.'] },
    { id: 'chickpea-bowl', name: 'Chickpea bowl', description: 'Fresh chickpeas with cucumber.', baseServings: 2, scope: 'custom', ingredients: [{ ingredientId: 'chickpeas', quantity: 300_000n }, { ingredientId: 'cucumber', quantity: 1_000n }], steps: ['Drain chickpeas.', 'Chop cucumber and combine.'] },
  ],
  activity: [

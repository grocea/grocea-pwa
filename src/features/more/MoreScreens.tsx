import { ArrowClockwise, ArrowRight, Basket, CheckCircle, Database, FolderSimple, Info, LockSimple, MagnifyingGlass, Plus, ShieldCheck, Trash, WarningCircle, WifiSlash } from '@phosphor-icons/react'
